...
function Main(){
  const targetBox=globalThis.document.querySelector(".observer-box");
  if(!(targetBox==null))observeElement(targetBox);
  const b=new _c_2("New_1");
  const p=CompleteHoles(b.k, b.h, []);
  const i=new _c_1(p[1], main(p[0]));
  let _1=(b.i=i,i);
  const _2=_1.Doc;
  LoadLocalTemplates("");
  _c_3.RunById("main", _2);
}
function observeElement(targetBox){
  let r;
  (new IntersectionObserver((entries) => {
    (((_3) => _3("for each"))((s) => {
      console.log(s);
    }));
    for(let i=0, _3=entries.length-1;i<=_3;i++){
      const entry=get(entries, i);
      const _1=entry.target;
      const _2=entry.isIntersecting;
      (((_4) => _4("Observed: "+String(_1)+", isIntersecting: "+String(_2)))((s) => {
        console.log(s);
      }));
      if(entry.isIntersecting){
        ...
        (((_4) => _4("Remove visible"))((s) => {
          console.log(s);
        }));
        entry.target.classList.remove("visible");
      }
    }
  }, (r={},r.threshold=0.5,r))).observe(targetBox);
}
...
function ofSeq(xs){
  ...
  else if(xs instanceof _c_33)return ofList(xs);
  else {
    const q=[];
    const o=Get(xs);
    try {
...
function CompleteHoles(key, filledHoles, vars){
  const allVars=new _c_4("New_5");
  const filledVars=new _c_6("New_3");
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      const r=ty===0?_c_7.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?"":o.$0);
        return new _c_8(name, _2);
      }):ty===1?_c_7.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?0:o.$0);
        return new _c_10(name, _2);
      }):ty===2?_c_7.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?false:o.$0);
        return new _c_11(name, _2);
      }):ty===3?_c_7.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?-8640000000000000:o.$0);
        return new _c_12(name, _2);
      }):ty===4?_c_7.GetOrAddHoleFor(key, name, () => new _c_13(name, _c_9.Create_1([]))):ty===5?_c_7.GetOrAddHoleFor(key, name, () => new _c_14(name, _c_9.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_7.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_9.Create_1(o==null?[]:o.$0);
...
function NamedTemplate(baseName, name, fillWith){
  ...
  return m[0]?ChildrenTemplate(m[1].cloneNode(true), fillWith):(console.warn("Local template doesn't exist", name),_c_3.Empty);
}
function LocalTemplatesLoaded(){
  return _c_21.LocalTemplatesLoaded;
}
function set_LocalTemplatesLoaded(_1){
  _c_21.LocalTemplatesLoaded=_1;
}
function LoadNestedTemplates(root, baseName){
  const loadedTpls=LoadedTemplateFile(baseName);
  const rawTpls=new _c_4("New_5");
  ...
  const instantiated=new _c_6("New_3");
...
function ChildrenTemplate(el, fillWith){
  ...
  return!Equals(m, null)&&m.length===1&&(get(m, 0)instanceof Node&&(Equals(get(m, 0).nodeType, Node.ELEMENT_NODE)&&(_1=get(m, 0),true)))?_c_23.TreeNode(docTreeNode, updates):_c_3.Mk(TreeDoc(docTreeNode), updates);
}
...
function PrepareTemplateStrict(baseName, name, fakeroot, prepareLocalTemplate){
  const processedHTML5Templates=new _c_6("New_3");
        ...
        case 1:
          ...
          if(instBaseName!=""&&!LoadedTemplates().ContainsKey(instBaseName))return failNotLoaded(instName);
            ...
            if(!d.ContainsKey(instName))return failNotLoaded(instName);
              ...
              const usedHoles=new _c_6("New_3");
              const mappings=new _c_4("New_5");
...
function InlineTemplate(el, fillWith){
  ...
  const tryGetAsDoc=(name) => {
    ...
    if(m[0]){
      const th=m[1];
      if(th instanceof _c_25)return Some(th.Value);
      else if(th instanceof _c_26)return Some(_c_3.TextNode(th.Value));
      else {
        const o_1=th.ForTextView();
        return o_1==null?null:Some(_c_3.TextView(o_1.$0));
      }
    }
    else return null;
  };
  foreachNotPreserved(el, "[ws-hole]", (p) => {
    ...
    if(m!=null&&m.$==1){
      ...
      holes.push(_c_22.New(Empty(p), doc.docNode, null, p, Int(), null));
  ...
  foreachNotPreserved(el, "[ws-replace]", (e_1) => {
    ...
    if(m!=null&&m.$==1){
      ...
      holes.push(_c_22.New(Empty(p), doc.docNode, Some([before, after]), p, Int(), null));
      updates.push(doc.updates);
    }
  });
  ...
  foreachNotPreserved(el, "[ws-on]", (e_1) => {
    addAttr(e_1, _c_30.Concat(choose((x_1) => {
      ...
      if(m[0]){
        const th=m[1];
        return th instanceof _c_28?Some(Handler(get(a, 0), th.Value)):th instanceof _c_29?Some(_c_30.Handler(get(a, 0), th.Value)):(console.warn("Event hole on"+get(a, 0)+" filled with non-event data", get(a, 1)),null);
      }
      else return null;
    ...
    for(let i=0, _7=holeAttrs.length-1;i<=_7;i++)((() => {
      ...
      const value=foldBack((_9, _10) =>(((t) => {
        ...
        return(t_1) => {
          ...
          return holeContent.$==1?[textBefore_1, _c_33.Cons(textAfter==""?holeContent.$0:Map_1((s_5) => s_5+textAfter, holeContent.$0), views)]:[textBefore_1+holeContent.$0+textAfter, views];
        };
      })(_9))(_10), res, [finalText, _c_33.Empty]);
      if(value[1].$==1){
        if(value[1].$1.$==1){
          if(value[1].$1.$1.$==1){
            if(value[1].$1.$1.$1.$==0){
      ...
      else _8=_c_30.Create(attrName, value[0]);
...
let _c_3=Lazy((_i) => class Doc extends _c {
  ...
  static TextView(txt){
    ...
    return _c_3.Mk(TextDoc(node), Map_1((t) => {
...
let _c_4=Lazy((_i) => class Dictionary extends _c {
  static {
    _c_4=_i(this);
  }
  equals;
...
let _c_6=Lazy((_i) => class HashSet extends _c {
  static {
    _c_6=_i(this);
  }
  equals;
  ...
  IntersectWith(xs){
    const other=new _c_6("New_4", xs, this.equals, this.hash);
...
function map_1(f, s){
  return{GetEnumerator:() => {
    const en=Get(s);
    return new _c_18(null, null, (e) => en.MoveNext()&&(e.c=f(en.Current),true), () => {
      en.Dispose();
    });
  }};
}
...
function concat_1(ss){
  return{GetEnumerator:() => {
    ...
    return new _c_18(null, null, next, (st) => {
      const x=st.s;
...
function initInfinite(f){
  return{GetEnumerator:() => new _c_18(0, null, (e) => {
    e.c=f(e.s);
    e.s=e.s+1;
    return true;
  }, void 0)};
...
let _c_7=Lazy((_i) => class TemplateInitializer extends _c {
  static {
    _c_7=_i(this);
  }
  static init;
  ...
  static GetHolesFor(id){
    let o;
    const m=(o=null,[_c_7.initialized.TryGetValue(id, {get:() => o, set:(v) => {
      o=v;
    }}), o]);
    if(m[0])return m[1];
    else {
      const d=new _c_4("New_5");
      _c_7.initialized.set_Item(id, d);
      return d;
    }
  }
  static {
    _c_7.initialized=new _c_4("New_5");
    _c_7.instances=new _c_4("New_5");
  }
});
let _c_8=Lazy((_i) => {
  Force(_c_5);
...
let _c_9=Lazy((_i) => class Var extends _c {
  ...
  static Create_1(v){
    return new _c_20(false, {s:Ready(v, [])}, v);
  }
  static { }
});
let _c_10=Lazy((_i) => {
...
let _c_16=Lazy((_i) => class Exception extends _c {
  static {
    _c_16=_i(this);
  }
});
...
let _c_18=Lazy((_i) => class T extends _c {
  static {
    _c_18=_i(this);
  }
  s;
...
let _c_19=Lazy((_i) => class Var extends _c {
  static {
    _c_19=_i(this);
  }
});
let _c_20=Lazy((_i) => {
  Force(_c_19);
  return class ConcreteVar extends _c_19 {
    static {
      _c_20=_i(this);
    }
    isConst;
...
let _c_21=Lazy((_i) => class $StartupCode_Templates {
  static {
    _c_21=_i(this);
  }
  ...
  static {
    this.LoadedTemplates=new _c_4("New_5");
    this.LocalTemplatesLoaded=false;
    this.GlobalHoles=new _c_4("New_5");
    this.TextHoleRE="\\${([^}]+)}";
...
function CreateElemNode(el, attr, children){
  ...
  return _c_22.New(attr_1, children, null, el, Int(), GetOptional(attr_1.OnAfterRender));
}
...
let _c_22=Lazy((_i) => class DocElemNode {
  static {
    _c_22=_i(this);
  }
  Attr;
...
let _c_23=Lazy((_i) => {
  ...
  return class Elt extends _c_3 {
    ...
    static TreeNode(tree, updates){
      const rvUpdates=_c_34.Create(updates);
...
function wrapMap(){
  return _c_38.wrapMap;
}
function defaultWrap(){
  return _c_38.defaultWrap;
}
function rxhtmlTag(){
  return _c_38.rxhtmlTag;
}
function rtagName(){
  return _c_38.rtagName;
}
...
let _c_24=Lazy((_i) => class KeyCollection extends _c {
  static {
    _c_24=_i(this);
  }
  d;
...
function BatchUpdatesEnabled(){
  return _c_36.BatchUpdatesEnabled;
}
...
function Static(attr){
  return _c_30.A3(attr);
}
function Dynamic(view, set_1){
  return _c_30.A1(new _c_40(view, set_1));
}
function EmptyAttr(){
  return _c_42.EmptyAttr;
}
...
function ValueWith(bind, var_1){
  const p=bind(var_1);
  return _c_30.Append(Static(p[0]), DynamicCustom(p[1], p[2]));
}
...
let _c_30=Lazy((_i) => class Attr {
  static {
    _c_30=_i(this);
  }
  static Handler(event, q){
    return _c_30.HandlerImpl(event, q);
  }
  static Concat(xs){
    const x=ofSeqNonCopying(xs);
    return TreeReduce(EmptyAttr(), _c_30.Append, x);
  }
...
let _c_33=Lazy((_i) => class FSharpList {
  static {
    _c_33=_i(this);
  }
  ...
  static Empty=Create_1(_c_33, {$:0});
  GetEnumerator(){
    return new _c_18(this, null, (e) => {
      const m=e.s;
...
let _c_34=Lazy((_i) => class Updates_1 {
  static {
    _c_34=_i(this);
  }
  c;
...
let _c_35=Lazy((_i) => class ValueCollection extends _c {
  static {
    _c_35=_i(this);
  }
  d;
...
function FindAll(doc){
  ...
  loop(doc);
  return NodeSet(new _c_6("New_2", q));
}
...
function cancel(c){
  c.k(Cc(new _c_48("New", c.ct)));
}
function UseAnimations(){
  return _c_39.UseAnimations;
}
function Actions(a){
...
let _c_37=Lazy((_i) => class $StartupCode_Abbrev {
  static {
    _c_37=_i(this);
  }
  static counter;
...
let _c_38=Lazy((_i) => class $StartupCode_DomUtility {
  static {
    _c_38=_i(this);
  }
  static defaultWrap;
...
let _c_39=Lazy((_i) => class $StartupCode_Animation {
  static {
    _c_39=_i(this);
  }
  ...
  static CubicInOut;
  static {
    this.CubicInOut=_c_44.Custom((t) => {
      const t2=t*t;
      return 3*t2-2*(t2*t);
    });
...
let _c_40=Lazy((_i) => class DynamicAttrNode extends _c {
  static {
    _c_40=_i(this);
  }
  push;
...
let _c_42=Lazy((_i) => class Client {
  static {
    _c_42=_i(this);
  }
  ...
  static {
    ...
    this.IntGetChecked=(el) => {
      ...
      let o;
      const s_8=el.value;
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_46.Blank(s_8):_c_46.Invalid(s_8);
      else {
        const m=(o=0,[TryParse(s_8, {get:() => o, set:(v) => {
          o=v;
        }}), o]);
        _1=m[0]?_c_46.Valid(m[1], s_8):_c_46.Invalid(s_8);
      }
      return Some(_1);
    };
    ...
    this.FloatGetChecked=(el) => {
      ...
      if(isBlank(s_8))_1=(el.checkValidity?el.checkValidity():true)?_c_46.Blank(s_8):_c_46.Invalid(s_8);
        ...
        const i=+s_8;
        _1=isNaN(i)?_c_46.Invalid(s_8):_c_46.Valid(i, s_8);
      }
      return Some(_1);
    };
...
let _c_43=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_43=_i(this);
  }
  idle;
...
let _c_44=Lazy((_i) => class Easing extends _c {
  static {
    _c_44=_i(this);
  }
  transformTime;
...
let _c_45=Lazy((_i) => class $StartupCode_Concurrency {
  static {
    _c_45=_i(this);
  }
  static GetCT;
  ...
  static {
    ...
    this.scheduler=new _c_43();
    this.defCTS=[new _c_47()];
    this.Zero=Return();
    this.GetCT=(c) => {
      c.k(Ok(c.ct));
    };
...
function Filter_1(ok, set_1){
  return new _c_6("New_2", filter(ok, ToArray_2(set_1)));
}
function Except_1(excluded, included){
  const set_1=new _c_6("New_2", ToArray_2(included));
...
function Intersect_1(a, b){
  const set_1=new _c_6("New_2", ToArray_2(a));
...
function StringSet(){
  return _c_42.StringSet;
}
function StringGet(){
  return _c_42.StringGet;
}
function StringListSet(){
  return _c_42.StringListSet;
}
function StringListGet(){
  return _c_42.StringListGet;
}
function DateTimeSetUnchecked(){
  return _c_42.DateTimeSetUnchecked;
}
function DateTimeGetUnchecked(){
  return _c_42.DateTimeGetUnchecked;
}
...
function FileSetUnchecked(){
  return _c_42.FileSetUnchecked;
}
function FileGetUnchecked(){
  return _c_42.FileGetUnchecked;
}
function IntSetUnchecked(){
  return _c_42.IntSetUnchecked;
}
function IntGetUnchecked(){
  return _c_42.IntGetUnchecked;
}
function IntSetChecked(){
  return _c_42.IntSetChecked;
}
function IntGetChecked(){
  return _c_42.IntGetChecked;
}
function FloatSetUnchecked(){
  return _c_42.FloatSetUnchecked;
}
function FloatGetUnchecked(){
  return _c_42.FloatGetUnchecked;
}
function FloatSetChecked(){
  return _c_42.FloatSetChecked;
}
function FloatGetChecked(){
  return _c_42.FloatGetChecked;
}
function StringApply(){
  return _c_42.StringApply;
}
function FloatApplyUnchecked(){
  return _c_42.FloatApplyUnchecked;
}
function BoolCheckedApply(){
  return _c_42.BoolCheckedApply;
}
function DateTimeApplyUnchecked(){
  return _c_42.DateTimeApplyUnchecked;
}
function FileApplyUnchecked(){
  return _c_42.FileApplyUnchecked;
}
function StringListApply(){
  return _c_42.StringListApply;
}
function isBlank(s){
  return forall_2(IsWhiteSpace, s);
}
let _c_46=Lazy((_i) => class CheckedInput {
  static {
    _c_46=_i(this);
  }
  get Input(){
...
let _c_47=Lazy((_i) => class CancellationTokenSource extends _c {
  static {
    _c_47=_i(this);
  }
  init;
...
let _c_49=Lazy((_i) => class $StartupCode_AppendList {
  static {
    _c_49=_i(this);
  }
  static Empty;
